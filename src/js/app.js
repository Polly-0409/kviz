(function () {
  ...
  const procedures = [
    ...
    {
      id: "vibroCompression",
      name: "Виброкомпрессионный массаж",
      description:
        "Компрессионно-вибрационная технология для уменьшения отёков, повышения тонуса кожи и выраженного антицеллюлитного эффекта.",
      indications: ["Отёчность и пастозность тканей", "Снижение тонуса", "Выраженный целлюлит"],
      limitations: ["Острые тромбозы и тромбофлебиты", "Беременность", "Обострение хронических заболеваний"],
      expectedEffect: "Более подтянутый вид кожи, уменьшение отёчности и ощущение лёгкости в теле.",
      sessionDurationMin: 50,
      baseSessions: 10,
      sessionsRange: [8, 15],
      baseFrequencyPerWeek: 2,
